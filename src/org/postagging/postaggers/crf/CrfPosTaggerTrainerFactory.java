...
/**
 * A factory which creates a {@link CrfPosTaggerTrainer}.
 * 
 * @author Asher Stern
 * Date: Nov 10, 2014
 *
...
{
	/**
	 * Creates a {@link CrfPosTaggerTrainer} with the standard set of features.
	 * @param corpus
	 * @return
	 */
	...
	/**
	 * Creates a {@link CrfPosTaggerTrainer} with a custom set of features, which are generated by
	 * the {@link CrfPosTaggerFeatureGenerator} that is created by the given {@link CrfPosTaggerFeatureGeneratorFactory}.
	 * 
	 * 
	 * @param corpus
	 * @param featureGeneratorFactory
	 * @return
	 */
