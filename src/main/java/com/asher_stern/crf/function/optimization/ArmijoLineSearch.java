...
import static com.asher_stern.crf.utilities.ArithmeticUtilities.safeDivide;
...
public class ArmijoLineSearch<F extends DerivableFunction> implements LineSearch<F>
{
	...
	public static final BigDecimal DEFAULT_INITIAL_ALPHA = new BigDecimal(1.0, ArithmeticUtilities.MC); // = 0.01;
	
	public static final BigDecimal MINIMUM_ALLOWED_ALPHA_VALUE_SO_SHOULD_BE_ZERO = new BigDecimal(0.000001, ArithmeticUtilities.MC);
